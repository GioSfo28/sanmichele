...
import { FaArrowLeft, FaCalendarAlt, FaMapMarkerAlt, FaRoute, FaStopwatch, FaClock, FaCheckCircle, FaInfoCircle, FaStar, FaUserFriends, FaMountain, FaShieldAlt, FaBus, FaArrowRight, FaHeart } from "react-icons/fa";
                        ...
                        <div className="relative bg-gradient-to-br from-sacra-primary via-sacra-secondary to-sacra-primary text-white p-8 sm:p-10 rounded-3xl shadow-2xl overflow-hidden">
                            ...
                            <div className="relative z-10">
                                ...
                                <div className="space-y-6">
                                    ...
                                    <div className="flex items-start gap-4 p-4 bg-white/10 rounded-2xl backdrop-blur-sm">
                                        <div className="p-3 bg-sacra-accent/20 rounded-xl shrink-0">
                                            <FaClock className="text-xl text-sacra-accent" />
                                        </div>
                                        <div>
                        ...
                        <div className="bg-white rounded-3xl shadow-2xl border border-gray-100 overflow-hidden">
                            ...
                            <div className="flex border-b border-gray-100">
                                {steps.map((step, i) => (
                                    <div
                                        key={i}
                                        className={`flex-1 flex items-center justify-center gap-2 py-4 text-sm font-semibold transition-all ${currentStep === i
                                                ? "text-sacra-primary bg-sacra-primary/5"
                                                : "text-gray-400"
                                            }`}
                                    >
